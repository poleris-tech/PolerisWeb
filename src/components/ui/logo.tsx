  ...
  return (
    <div className={`flex items-center gap-3 md:gap-4 ${className}`}>
      ...
      <div className="flex flex-col leading-none">
        <span
          className={`font-black text-2xl md:text-3xl lg:text-4xl uppercase tracking-tighter transition-colors duration-300 ${
            isWhite ? 'text-white' : 'text-[#001f3f] dark:text-white'
          }`}
        ...
        <span
          className={`font-semibold text-[0.65rem] md:text-xs uppercase tracking-[0.2em] mt-0.5 transition-colors duration-300 ${
            isWhite ? 'text-white/70' : 'text-[#001f3f]/60 dark:text-white/70'
          }`}
        >
          DIGITAL
        </span>
