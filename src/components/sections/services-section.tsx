    ...
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="text-center mb-12 sm:mb-16 md:mb-20 flex flex-col items-center w-full">
          ...
          <div className="max-w-3xl mx-auto w-full" style={{ marginTop: '48px' }}>
        ...
        {/* Services Grid */}
        <div className="flex justify-center w-full mb-12 sm:mb-16" style={{ marginTop: '60px' }}>
          ...
          {SERVICES.map((service) => {
            ...
            return (
              <li key={service.id} className="group relative">
                <div className="relative flex flex-col h-full rounded-3xl bg-white border-2 border-gray-100 px-8 py-12 sm:px-10 sm:py-14 transition-all duration-700 hover:border-blue-500/50 hover:shadow-[0_20px_70px_-15px_rgba(0,31,63,0.3)] hover:-translate-y-3 overflow-hidden">
                  ...
                  {/* Icon Container */}
                  <div className="relative inline-flex self-center" style={{ marginTop: '24px', marginBottom: '40px' }}>
                    ...
                    {/* Icon */}
                    <div className="relative flex justify-center items-center rounded-2xl bg-gradient-to-br from-[#001f3f] via-[#002855] to-[#003d6b] h-24 w-24 transition-all duration-700 group-hover:scale-110 group-hover:rotate-6 group-hover:from-blue-500 group-hover:via-cyan-500 group-hover:to-blue-600 shadow-xl group-hover:shadow-2xl">
                      {IconComponent && (
                        <IconComponent className="h-12 w-12 text-white relative z-10" strokeWidth={1.5} />
                      )}
                    </div>
                  </div>

                  {/* Title */}
                  <h3 className="text-2xl font-bold text-[#001f3f] text-center transition-colors duration-500 group-hover:text-blue-700" style={{ marginBottom: '32px', lineHeight: '1.4', paddingLeft: '16px', paddingRight: '16px' }}>
                    {service.title}
                  </h3>

                  {/* Description */}
                  <p className="text-base text-[#001f3f]/70 text-center transition-colors duration-500 group-hover:text-[#001f3f]/80" style={{ marginBottom: '40px', lineHeight: '1.8', paddingLeft: '16px', paddingRight: '16px' }}>
                    {service.description}
                  </p>

                  {/* Features List */}
                  <ul className="mt-auto" style={{ display: 'flex', flexDirection: 'column', gap: '20px', paddingLeft: '16px', paddingRight: '16px' }}>
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start text-base text-[#001f3f]/80 transition-all duration-500 group-hover:text-[#001f3f]" style={{ gap: '16px' }}>
                        <span className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 group-hover:bg-blue-500 flex items-center justify-center transition-all duration-500" style={{ marginTop: '4px' }}>
                          <svg className="w-3.5 h-3.5 text-blue-600 group-hover:text-white transition-colors duration-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
