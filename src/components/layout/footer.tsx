        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-16 px-4 sm:px-0">
          ...
          <div className="lg:col-span-3">
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <li>
                <a href="/" className="text-white/70 hover:text-white transition-colors duration-300 font-light">
                  Home
                </a>
              </li>
              <li>
          ...
          <div className="lg:col-span-4">
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+16178383859" className="text-white/70 hover:text-white transition-colors duration-300 font-light">
                  (617) 838-3859
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:polerisllc@outlook.com" className="text-white/70 hover:text-white transition-colors duration-300 font-light break-words">
